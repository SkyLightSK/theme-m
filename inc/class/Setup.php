...
{
    /**
     * Construct main Mogul setup
     *
     * @since	1.0.0
     */
    public function __construct()
    {
        add_action( 'after_setup_theme', array( $this, 'mogul_setup' ) );
        add_action( 'after_setup_theme', array( $this, 'mogul_content_width'), 0 );

    }

    /**
     * Mogul setup function
     *
     * @since	1.0.0
     */
    public function mogul_setup()
    {
        /*
        ...
        register_nav_menus( array(
            ...
            'footer-socials' => esc_html__( 'Footer Socials', 'mogul' ),
        ) );
     ...
     */
    public function mogul_content_width() {
